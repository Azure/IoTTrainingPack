...
- **Root CA certificate:** a root Certificate Authority (CA) certificate
  ...
  certificate used to identify the IoT Hubs is generated by a Microsoft
  Intermediate CA which has been created using a well know commercial
  CA: the *DigiCert Global G2 Root CA*.
...
chain, where a certain device or machine which trusts a Root CA or an
...
style="width:6.69291in;height:2.99056in" />

There are different certificates used by an IoT Edge device:

<img src="./media/image6.png" style="width:6.5in;height:2.35016in" />
...
<img src="./media/image8.png" style="width:6.5in;height:3.53451in" />
...
style="width:6.59509in;height:2.5599in" />
...
recommends using moby-engine on production systems to provide the best
class support.
